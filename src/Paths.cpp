...
fs::path getResourcesPresetsPath( const string &path )
{
	return addPath( getResourcesPath( PRESETS_PATH ), path );
}
...
fs::path getAppSupportModelAssetsPath( const string &path )
{
	return addPath( getAppSupportAssetsPath( MODEL_PATH ), path );
}
...
fs::path getAppSupportPresetsSessionPath( const string &path )
{
	return addPath( getAppSupportPath( PRESETS_PATH ), path );
}
} // namespace paths
} // namespace reza
